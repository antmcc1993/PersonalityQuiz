...
class QuestionViewController: UIViewController {
    ...
    @IBAction func singleAnswerButtonPressed(_ sender: UIButton) {
     let curentAnswers = questions[questionIndex].answers
        
        switch sender {
        case singleButton1:
            answerChosen.append(curentAnswers[0])
        case singleButton2:
            answerChosen.append(curentAnswers[1])
        case singleButton3:
            answerChosen.append(curentAnswers[2])
        case singleButton4:
                answerChosen.append(curentAnswers[3])
        default:
            break
        }
        nextQuestion()
